    ...
    for job in models.Job.objects:
        ...
        if len(newJobs):
            ...
            for j in newJobs:
                ...
                if tstatus == "Submitted": j.minor_status = "JobPending"
                elif tstatus == "Running": j.minor_status = random.choice(["RunningExecutionWrapper","CopyingInputFiles","AssemblingOutputFiles"])
