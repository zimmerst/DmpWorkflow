...
def main(args=None):
    ...
    parser.add_argument("-S", "--setStatus", dest="status", type=str, default="New",
                        help='site where the file is registered')
    parser.add_argument("-x", "--expandVars", dest="expandVars", action='store_true', default=False,
                        help='if true, store absolute paths')
    parser.add_argument("-q", "--quiet", dest="quiet", action='store_true', default=False,
                        help='if true, keep only essential information')
    parser.add_argument("-F", "--force", dest="force", action='store_true', default=False,
                        help='if true, force overwriting existing file')
