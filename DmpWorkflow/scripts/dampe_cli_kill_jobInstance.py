...
def main(args=None):
    ...
    parser.add_argument("--status", dest="stat", type=str, default="Running",
                        help='jobs to be picked for killing jobs, Any will return all statii!', required=False)
